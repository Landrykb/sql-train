  ...
  return (
    <main className="max-w-5xl mx-auto space-y-6 sm:space-y-10 bg-bleepx-bg min-h-screen pb-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="bg-bleepx-white rounded-xl p-4 text-center shadow-sm border border-bleepx-border">
          <div className="text-2xl font-bold text-amber-600">{Object.values(LAB_CASE_ORDER).flat().length}</div>
          <div className="text-xs text-bleepx-text-secondary mt-0.5">Steps</div>
        </div>
        <div className="bg-bleepx-white rounded-xl p-4 text-center shadow-sm border border-bleepx-border">
          <div className="text-2xl font-bold text-emerald-600">3</div>
          <div className="text-xs text-bleepx-text-secondary mt-0.5">Difficulty Levels</div>
        </div>
        <div className="bg-bleepx-white rounded-xl p-4 text-center shadow-sm border border-bleepx-border">
          <div className="text-2xl font-bold text-teal-600">Python + R</div>
          <div className="text-xs text-bleepx-text-secondary mt-0.5">Languages</div>
        </div>
      </div>
      ...
      <div id="projects">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          {domains.map((d) => {
            ...
            const steps = LAB_CASE_ORDER[d]?.length || 0;
                ...
                <div className="p-4 sm:p-5 flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-2 flex items-center gap-3 flex-wrap">
                      ...
                      <span className="text-[10px] text-bleepx-text-secondary ml-auto">{steps} steps</span>
                    </div>
                  </div>
