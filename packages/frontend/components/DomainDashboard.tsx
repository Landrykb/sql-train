                ...
                onClick={() => {
                  ...
                  try {
                    ...
                    if (!profile.githubUsername) {
                      const connect = confirm('*bleep* Connect your GitHub first to make portfolio exports more valuable. Connect now?');
                      if (connect) {
                        const username = prompt('Enter your GitHub username:');
                        if (username) {
                          const updated = { ...profile, githubUsername: username };
                          localStorage.setItem('bleepx_profile', JSON.stringify(updated));
                        }
                      }
                    }
                  } catch { /* ignore */ }
